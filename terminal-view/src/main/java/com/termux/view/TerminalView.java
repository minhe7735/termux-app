...
public final class TerminalView extends View {
    ...
    public void setTextSize(int textSize) {
        if (mRenderer == null) {
            ...
            mRenderer = new TerminalRenderer(textSize, mRenderer.mTypefaceData, mRenderer.mTypefaceDataItalic, mRenderer.mTypefaceDataBold, mRenderer.mTypefaceDataItalicBold);
        }
        updateSize();
    }

    public void setTypeface(Typeface newTypeface) {
        mRenderer.setTypeface(newTypeface);
        updateSize();
        invalidate();
    }

    public void setItalicTypeface(Typeface newItalicTypeface) {
        mRenderer.setItalicTypeface(newItalicTypeface);
        updateSize();
        invalidate();
    }

    public void setBoldTypeface(Typeface newBoldTypeface) {
        mRenderer.setBoldTypeface(newBoldTypeface);
        updateSize();
        invalidate();
    }

    public void setItalicBoldTypeface(Typeface newItalicBoldTypeface) {
        mRenderer.setItalicBoldTypeface(newItalicBoldTypeface);
        updateSize();
        invalidate();
    }
